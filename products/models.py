...
class Products(models.Model):
    ...
    productname = models.CharField(db_column='productName', max_length=25)  # Field name made lowercase.
    ...
    sellprice = models.IntegerField(db_column='sellPrice')  # Field name made lowercase.
    buyprice = models.IntegerField(db_column='buyPrice')  # Field name made lowercase.
